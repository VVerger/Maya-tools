...
class AssetMainWindow(QMainWindow, Add, ToolboxPages, FileManagment):
    ...
    def __init__(self):
        ...
        toolbarMain.addSeparator()
            ...
            #FBX button
        fbxButton_action = QAction(QIcon(self.ressourcePath + "/icon/fbx.png"), "FBX", self)
        fbxButton_action.setStatusTip("Fbx for SubstancePainter")
        fbxButton_action.triggered.connect(self.saveFBX)
        toolbarMain.addAction(fbxButton_action)
